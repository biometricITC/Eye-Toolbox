...
+
The evaluator may change, for example, color effect of camera to change quality of the videos. Such change may affect the texture of artefacts that may lead to false acceptance. 
* Presentation method
+ 
