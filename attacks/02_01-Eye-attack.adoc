...
== Overview
The evaluator captures and displays target user's eye on a screen and present it to the TOE.
...
. The evaluator shall refer publicly available information to change default setting of the camera (e.g. image resolution) to create clearer eye artefacts.
